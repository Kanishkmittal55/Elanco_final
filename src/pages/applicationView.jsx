    ...
    <div>
      <div>
        ...
        <div className="w-[100%] flex flex-col items-center justify-center mb-4">
          ...
          {params.login} Application has {applicationData.length} entries, with
          total cost {sum.toFixed(2)}, and has total Consumed Quantity as{" "}
          {ConsumedQuantity.toFixed(2)}
          <div>Search Parameter Used : {text2} </div>
        </div>
        ...
        <div className="w-[100%] flex flex-col flex-wrap mb-[100px] mt-[100px] items-center justify-center">
          ...
          <div className="mt-[15vh] mb-[10vh] w-[60%] border-solid border-2 border-blue-900 p-[3vh] flex justify-center items-center flex-col">
            ...
            <p className="mb-[5vh]">
              Y - Axis ( The Quantity of Resources Consumed by the process on X
              - Axis){" "}
            </p>
            <p>
              {" "}
              You can Answers to Questions like which service Consumes the most
              out of the Available Resources to a Specific Application ?
            </p>
            <p className="mb-[4vh] ">
              {" "}
              For Example - <u>{applications_names_cq_max}</u>, service consumes
              the <u>most</u> resources for an <u>{params.login} Application</u>
            </p>
            <NameChart />
          </div>
